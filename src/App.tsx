...
import { ConfirmProvider } from "./contexts/ConfirmContext2";
              ...
              <div className="dropdown dropdown-end">
                ...
                >
                  ...
                  <li>
                    <button
                      onClick={logout}
                      className="text-error flex items-center space-x-2"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
    ...
    <div className="flex h-screen bg-base-200">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-auto">
          <Routes>
            {/* Legacy flat routes — stay unchanged for backward compat */}
            ...
            {/* Environment-aware routes — prefix /env/:envId */}
            <Route path="/env/:envId" element={<EnvAwareLayout />}>
